...
export function SideRadioButton() {
  return(
    <>
      <div className="flex">
        <input type="radio" id="settings_index-1" name="settings_index" className="appearance-none peer" value={1} defaultChecked />
        ...
        peer-checked:text-[#3EE167] transition-all duration-500 ">
      ...
      <div className="flex">
        <input type="radio" id="settings_index-2" name="settings_index" className="appearance-none peer" value={2} />
      ...
      <div className="flex">
        <input type="radio" id="settings_index-3" name="settings_index" className="appearance-none peer" value={3} />
